...
var featureItems = new _revealOnScroll2.default((0, _jquery2.default)(".feature-item"), "85%");
var testimonials = new _revealOnScroll2.default((0, _jquery2.default)(".testimonial"), "60%");
...
var Modal = function () {
    ...
    _createClass(Modal, [{
        ...
        value: function events() {
            ...
            // push any key
            (0, _jquery2.default)(document).keyup(this.keyPressandler.bind(this));
        }
    }, {
        key: "keyPressandler",
        value: function keyPressandler(e) {
            if (e.keyCode == 27) {
                this.closeModal();
            }
        }
